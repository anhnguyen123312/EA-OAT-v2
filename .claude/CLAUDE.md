...
| **Technical Analyst** | Convert PM plan → MQL5 technical specs | Phase 1: Specs |
...
```
Researcher → PM → Technical → REVIEWER (gate) → Coder → Backtester → Lead
                                                                        ↓
                                                              Targets met? → DONE
                                                              Targets miss? → New iteration
                                                                               ↓
                                                              Lead creates tasks → LOOP BACK
```
